# Escreva um programa em Python que leia dois arquivos.
# Seu programa deve somar elemento por elemento de 
# cada arquivo e imprimir o resultado na tela. 
# Isto é, o primeiro elemento de a.txt deve ser somado
# ao primeiro elemento de b.txt, segundo elemento de a.txt
# deve ser somado ao segundo elemento de b.txt, e assim 
# sucessivamente. Caso um arquivo tenha mais elementos 
# que o outro, os elementos que sobrarem do maior devem ser somados a zero.
